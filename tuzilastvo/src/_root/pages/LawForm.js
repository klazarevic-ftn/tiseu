  ...
  <div className="flex flex-col shadow-inner">
    <div className="title-container w-full border-b text-center">
      <div className="title-container w-full text-center">
        <h2 className="form-title text-xl md:text-2xl text-gray-600 mt-2 md:mt-4 mb-2 md:mb-4 ">Law Creation Hub</h2>
      </div>
    </div>
    ...
    {currentStep === 1 && (
      ...
      <div className="field-wrap flex flex-col w-full text-sm mb-4">
        ...
        <div className="field-wrap flex flex-col w-full text-sm mb-4">
          ...
          <select
              ...
              onChange={handleInputChange}
          >
              <option className="text-gray-500 " value="criminal">Parliament</option>
              <option className="text-gray-500 " value="civil">Congress</option>
              <option className="text-gray-500 " value="family">Local Council</option>
          </select>
      </div>
      ...
      <div className="buttons-containter-wrap w-full flex my-3 lg:mt-3 justify-center border-t border-b ">
        <div className="buttons-content w-full md:w-2/3 lg:w-1/2 flex justify-start px-10 pt-6 pb-9 " >
            ...
            <button  className=" h-full px-10 py-2 text-sm rounded bg-white text-gray-600  hover:bg-gray-50 border focus:outline-none hover:border-gray-300 hover:text-w">
                  Next
                </button>
        </div>
      </div>
